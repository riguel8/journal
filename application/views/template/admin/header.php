            ...
            <div><!-- ---------------------------------- -->
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="<?php echo base_url("users")?>">
                        <iconify-icon icon="ph:users-three" class="aside-icon"></iconify-icon>
                        <span class="hide-menu">Users</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a class="sidebar-link" href="<?php echo base_url("authors")?>">
                        <iconify-icon icon="mdi:users-check-outline" class="aside-icon"></iconify-icon>
