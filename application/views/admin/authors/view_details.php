  ...
  <div class="container-fluid">
    <div class="font-weight-medium shadow-none position-relative overflow-hidden mb-4">
      <div class="d-sm-flex d-block justify-content-between align-items-center">
        <h5 class="mb-0 fw-semibold text-uppercase">Author's Profile</h5>
      ...
      <div class="col-lg-4 col-xlg-3 col-md-5">
        <div class="card">
          <div class="card-body text-center">
            <center class="mt-3">
				      <img src="<?php echo site_url(); ?>assets/images/users/<?php echo $author['images']; ?>" class='rounded-circle' width='200' height="200">
            </center>
            <h4 class="card-title mt-2" style="font-size: 18px;"><?php echo $author['title']; ?> <?php echo $author['author_name']; ?></h4>
        ...
        <div class="card ">
          <div class="card-body">
            <div class="mb-4">
              ...
              <h6 style="font-size: 20px;"><?php echo $author['email']; ?></h6>
            </div>
            <div class="mb-4">
              <small class="text-muted" style="font-size: 18px;">Phone</small>
              <h6 style="font-size: 20px;"><?php echo $author['contact_num']; ?></h6>
            </div>
            <!-- <div class="mb-4">
              <small class="text-muted" style="font-size: 18px;">Article Title</small>
              <h6 style="font-size: 20px;"><?php echo $author['title']; ?></h6>
            </div> -->
